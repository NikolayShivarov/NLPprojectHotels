...
booking_df = pd.read_csv("booking_reviews_processed_numerical.csv")
tripadvisor_df = pd.read_csv("tripadvisor_reviews_processed_numerical.csv")

tripadvisor_df["Rating"] = tripadvisor_df["Rating"] * 2

# Combine the reviews and ratings into a single DataFrame
df = pd.concat([booking_df, tripadvisor_df], ignore_index=True)
